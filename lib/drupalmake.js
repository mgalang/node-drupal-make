...
DrupalMake.linkSiteFiles = function(){
  var _theme_path = path.join(this.opts.final_build, 'sites/all/themes'),
      _files_path = path.join(this.opts.final_build, 'sites/default/files');
      _modules_path = path.join(this.opts.final_build, 'sites/all/modules/custom');
  ...
  fs.linkSync(
    ...
    path.join(this.opts.final_build, 'sites/default/settings.php')
  );
};
